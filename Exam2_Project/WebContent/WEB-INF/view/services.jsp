                        ...
                        <nav class="navbar navbar-expand-lg">
                          ...
                          <div class="collapse navbar-collapse tm-nav" id="navbarSupportedContent1">
                            ...
                            <ul class="navbar-nav mr-auto">
                              <li class="nav-item">
                                <a class="nav-link tm-nav-link" href="index.jsp">Home <span class="sr-only">(current)</span></a>
                              </li>
                              <li class="nav-item">
                                <a class="nav-link tm-nav-link" href="company.jsp">Our Company</a>
                              </li>
        ...
        <main>
            ...
            <section class="tm-welcome">
                ...
                <div class="row tm-welcome-row tm-services">
                	...
                	<c:forEach var="detailInfo" items="${services}">
                	
						<div class="col-md-3 col-sm-6">
                        <figure class="tm-services-img">
                            <img src="${detailInfo.img}" alt="Image" class="img-fluid">        
                            <figcaption class="tm-service-description">${detailInfo.caption}</figcaption>
                        </figure>
                    </div>
